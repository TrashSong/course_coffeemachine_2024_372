package ua.com.kisit2024.course_coffeemachine_2024_372.security;
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((authorize)->
                        authorize
                                .requestMatchers("/","/payment","/order","/thank","/cart",
                                        "/registration","/registration/**","/addToCart",
                                        "/updateItemInCart","/deleteItemFromCart","/deleteAllItem",
                                        "/static/**")
                                .permitAll()
